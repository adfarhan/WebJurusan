                ...
                <form action="{{ route('alumni.update', $alumnibmw->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            value="{{ old('angkatan', $alumnibmw->angkatan) }}" 
                            required
                        >
                        @error('angkatan')
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            value="{{ old('bekerja', $alumnibmw->bekerja) }}" 
                            required
                        >
                        @error('bekerja')
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            value="{{ old('melanjutkan', $alumnibmw->melanjutkan) }}" 
                            required
                        >
                        @error('melanjutkan')
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            value="{{ old('wirausaha', $alumnibmw->wirausaha) }}" 
                            required
                        >
                        @error('wirausaha')
                        <div class="invalid-feedback">
