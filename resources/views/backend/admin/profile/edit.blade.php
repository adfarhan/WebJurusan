    ...
    <div class="container mb-5 mt-5">
        <div class="card shadow-lg">
            <div class="card-header border-0" style="background: #f7e015">
                <h2 class="mb-0" style="color: #fff ; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8);"> Edit Profil Alumni</h2>
            </div>
            <div class="card-body">
                <form action="{{ route('profil.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <p>
                            <img id="foto-preview" src="{{ asset('storage/' . $profile->foto) }}" alt="Preview Gambar" class="mt-3" style="max-width: 20%; height: auto; border-radius: 8px;">
                        </p>
                    </div>
