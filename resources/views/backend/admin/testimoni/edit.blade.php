...
<body>
    <div class="container d-flex justify-content-center align-items-center">
        <div class="card p-4">
            <div class="card-header">Edit Testimoni Alumni</div>
            <div class="card-body">
                <form action="{{ route('testimoni.update', $testimoni->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="testimoni_alumni" id="testimoni_alumni" class="form-control" rows="4" required>{{ old('testimoni_alumni', $testimoni->testimoni_alumni) }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($testimoni->image_alumni)
                            <img id="image-preview" class="image-preview mt-3" src="{{ asset('storage/' . $testimoni->image_alumni) }}" alt="Foto Testimoni">
                        @endif
                    </div>
