...
<body>
    <div class="container d-flex justify-content-center align-items-center">
        <div class="card p-4">
            <div class="card-header">Edit Projek</div>
            <div class="card-body">
                <form action="{{ route('projek.update', $projek->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" required>{{ $projek->deskripsi }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Unggah Sample dalam format .jpg, .jpeg, atau .png</small>
                        <img id="image-preview" class="image-preview mt-3" src="{{ asset('storage/' . $projek->gambar) }}" alt="Preview Gambar">
                    </div>
