  ...
  <body>
    ...
    <div class="container mb-5 mt-5">
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form action="{{ route('kebiasaan.update', $projek->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label for="judul_projek" class="form-label">Judul Proyek</label>
                        <input type="text" name="judul" id="judul" class="form-control" value="{{ $projek->judul }}" required>
                    </div>
